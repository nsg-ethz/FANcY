...
//typedef bit<5> hash_size_t;
#define COUNTER_NODE_WIDTH 32
typedef bit<5> hash_size_t;

#define ALL_PORTS_COUNTERS 1024 // COUNTER_NODE_WIDTH x NUM_SWITCH_PORTS
