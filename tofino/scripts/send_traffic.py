...
def send_packet(iface, addr="10.10.10.10", count=1, delay=0, tos=0):
    for i in range(count):
        pkt = Ether(src="88:88:88:88:88:88", dst='00:01:02:03:04:05')
...
def send_fancy_packet(
    ...
    pkt = Ether(src="88:88:88:88:88:88", dst='00:01:02:03:04:05', type=_FANCY)
    pkt = pkt / FANCY(id=0, count_flag=count, ack=ack, fsm=fsm,
