...
def generate_ns3_runs(
    ...
    fail_time = 2
    traffic_start = 1
    # fixed from our simulations
    input_dir = "inputs_sigcomm2022/dedicated/dedicated"
    ...
    # build commands
    for run in runs:
        cmd = './waf --run  "main --DebugFlag=false --PcapEnabled=False --FailTime={} --TrafficStart={} --InDirBase={} --EnableSaveDrops=false --SoftDetectionEnabled=false --CheckPortStateEnable=false --TrafficType=StatefulSyntheticTraffic --SwitchType=Fancy --EnableNat=true --NumReceivers=5 --NumSendersPerRtt=5 --PacketHashType=DstPrefixHash --NumDrops={}'.format(
